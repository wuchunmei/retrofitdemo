...
import demo.wuchunmei.com.retrofitdemo.main.help.AutoScrollViewPagerHelper;
...
public class InfiniteViewPager extends ViewPager {
    ...
    private AutoScrollViewPagerHelper.OnSwitchListener mSwitchListener;
...
//                log("onPageSelected:" + position);
                ...
                if(mSwitchListener != null) {
                    int realArg = getAdapterSize() / FakePositionHelper.MULTIPLIER;
                    mSwitchListener.onSwitch(position % realArg);
                }
            }
...
//        getParent().requestDisallowInterceptTouchEvent(true); // 注释掉这句为了是读书头图的ViewPager能够支持下拉刷新
    ...
    public void setSwitchListener(AutoScrollViewPagerHelper.OnSwitchListener listener) {
